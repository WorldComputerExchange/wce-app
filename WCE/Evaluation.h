...
@property (nonatomic, retain) NSString *q18;
@property (nonatomic, retain) NSString *q19;
@property (nonatomic, retain) NSString *q20;
@property (nonatomic, retain) NSString *q21;
@property (nonatomic, retain) NSString *q22;
@property (nonatomic, retain) NSString *q23;
@property (nonatomic, retain) NSString *q24;
@property (nonatomic, retain) NSString *q25;
@property (nonatomic, retain) NSString *q26;
@property (nonatomic, retain) NSString *q27;
@property (nonatomic, retain) NSString *q28;
